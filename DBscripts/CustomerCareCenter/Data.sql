...
VALUES(1,'Telefono','Telefono Celular',1),(2,'Correo','Correo Electrónico',1);

INSERT INTO `account_type`(idAccountType,`name`,`description`,`enable`)
VALUES(1,'Admin Account','Cuenta de administrador',1),(2,'User Account','Cuenta de usuario',1);

INSERT INTO `permission`(idPermission,`name`,`description`,`enable`)
VALUES(1,'Admin','Admin full of permissions',1),(2,'User','User permissions',1);
...
VALUES(1,1,1,'78080906',1),(2,2,1,'71050807',1),(3,3,1,'78074906',1),(4,4,1,'70401020',1);
