...
CREATE NONCLUSTERED INDEX [fkIdx_446] ON [Stock]
    (
     [idProduct] ASC
        )
...
CREATE NONCLUSTERED INDEX [fkIdx_431] ON [Sale]
    (
     [idProduct] ASC
        )
...
(
    ...
    CONSTRAINT [FK_421] FOREIGN KEY ([idScore]) REFERENCES [Score] ([idScore])
);
GO
